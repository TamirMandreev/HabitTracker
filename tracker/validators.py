...
class ExcludeRelatedRewardValidator:
    ...
    def __call__(self, data):
        ...
        reward = data.get(self.reward_name) # Получаем значение поля reward из переданных данных
...
class LinkRelatedNiceValidator:
    ...
    def __call__(self, data):
        related_habit = data.get(self.related_habit_name) # Получаем значение поля related_habit из переданных данных. Это объект модели Habit.
